...
_register(DocTypeProfile("work_order", "Work Order", "manufacturing", "Work Order", False, False, False, False, False, False, False, "planned_start_date", None, None, THEMES_STOCK + ["manufacturing", "executive", "technical"]))
_register(DocTypeProfile("job_card", "Job Card", "manufacturing", "Job Card", False, False, False, False, False, False, False, "posting_date", None, None, THEMES_STOCK + ["manufacturing", "technical"]))
_register(DocTypeProfile("production_plan", "Production Plan", "manufacturing", "Production Plan", False, False, False, False, False, False, False, "posting_date", "customer", "customer", THEMES_STOCK + ["manufacturing", "executive", "technical", "landscape"]))
